        ...
        <Pressable style={[styles.contentContainer, { width: modalWidth }]}>
          ...
          {actions && (<View style={styles.buttonContainer}>
              {secondary ? (<>
                  ...
                  <TouchableOpacity style={[styles.button, { backgroundColor: '#ff9225' }, primaryButtonStyle]} onPress={handleButtonPress(primary === null || primary === void 0 ? void 0 : primary.onPress)}>
                    <Text numberOfLines={1} style={[styles.buttonText, { color: 'white', fontFamily: fontFamily }, primaryButtonTextStyle]}>{primary === null || primary === void 0 ? void 0 : primary.label}</Text>
                  </TouchableOpacity>
                  ...
                  <Text numberOfLines={1} style={[styles.buttonText, { color: '#FF7F00', textAlign: 'right', marginBottom: 5, marginRight: 5, fontFamily: fontFamily }, singleButtonTextStyle]}>{primary === null || primary === void 0 ? void 0 : primary.label}</Text>
                </TouchableOpacity>)}
            </View>)}
        </Pressable>
      </Animated.View>);
